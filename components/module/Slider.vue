<template>
    <div class="flex flex-col w-full">
        ...
        <ClientOnly>
            <swiper-container class="w-full pt-8 container mx-auto px-4" ref="containerRef" :slidesPerView="1" :autoHeight="true"
                :breakpoints="breakpoints" :mousewheel="{ invert: true }" :autoplay="{ delay: 3000, enabled: true }"
                :spaceBetween="10">
